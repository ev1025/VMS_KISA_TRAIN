...
$ROOT      = Split-Path -Parent $PSScriptRoot   # scripts/data_prep 상위(루트)
...
Write-Host "[완료] 추출 끝 -> 다음: python scripts/data_prep/05_hn_mine.py score --weights work/onnx_final/yolov8m.onnx"
